...
const DetailsPage: React.FC = () => {
  ...
  //const myImage = new CloudinaryImage(product.id, { cloudName: 'dpnnlqglr' }).resize(fill());
  return (
            ...
            <Grid container
              ...
              <Grid item sm={12} md={6}>
                <Stack spacing={2} justifyContent="center"
                  alignItems="center" >
                  <img src={`https://res.cloudinary.com/dpnnlqglr/image/upload/c_fill/${product.id}`} width="100%" />
